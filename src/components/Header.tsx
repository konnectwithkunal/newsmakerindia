    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      />
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a onClick={() => handleNavClick("work")} className={`cursor-pointer text-lg transition-colors duration-300 ${isScrolled ? "text-black hover:text-primary" : "text-white hover:text-primary"}`}>
            Work
          </a>
          ...
          <a onClick={() => handleNavClick("people")} className={`cursor-pointer text-lg transition-colors duration-300 ${isScrolled ? "text-black hover:text-primary" : "text-white hover:text-primary"}`}>
            Clients
          </a>
          <a onClick={() => handleNavClick("news")} className={`cursor-pointer text-lg transition-colors duration-300 ${isScrolled ? "text-black hover:text-primary" : "text-white hover:text-primary"}`}>
            News
          </a>
        </nav>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-background border-t border-border">
          <nav className="container mx-auto px-6 py-4 space-y-4">
            <a onClick={() => handleNavClick("work")} className="block py-2 text-foreground hover:text-primary transition-colors cursor-pointer">
              Work
            </a>
            ...
            <a onClick={() => handleNavClick("people")} className="block py-2 text-foreground hover:text-primary transition-colors cursor-pointer">
              Clients
            </a>
            <a onClick={() => handleNavClick("news")} className="block py-2 text-foreground hover:text-primary transition-colors cursor-pointer">
              News
            </a>
            <Button
              variant="default"
